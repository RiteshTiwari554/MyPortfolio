...
export const techStack = [
  ...
  { name: "C++ Language", link: "https://cdn-icons-png.flaticon.com/512/6132/6132222.png" },
...
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/riteshtiwari527/' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/RiteshTiwari554'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/ritesh-tiwari-207970211/'}
]
...
export const Project = [
  {
    Image: Moviepng,
    Title:"Dizkuz",
    description:"Dizkuz is a platform for a complete organisation to work seemlessly on any project, where One should Create Organisation work there and raise issue have discussion on any perticular issue.",
    Github:"https://github.com/RiteshTiwari554/Dizkuz",
  },
  {
    Image: Foodvillapng,
    Title:"The Food-Villa",
    description:"Foodvilla is a online webapp which is used to track the reataurant and all the recommended menu items from that Reataurant and place a order by adding it in a cart.",
    Github:"https://github.com/RiteshTiwari554/The-foodvila",
  },
  {
    Image: Moviepng,
    Title:"The House Of The Movies",
    description:"The House of Movies is a responsive website where you can get detailed information and ratings on movies and web series.You are also able to watch trailers. It fetches all the information from The MovieDB API.",
    Github:"https://github.com/RiteshTiwari554/houseofMovies",
  },
  {
    Image: Netflixpng,
    Title:"Netflix2.0",
